...
public class PanelDetallesRestaurante extends JPanel
{
    ...
    {
        // Layout con 3 filas para los 3 elementos
        ...
        chkVisitado.setEnabled(false);  // Solo es visual, no editable
        add(chkVisitado);
    }
    ...
    private void actualizarRestaurante(String nombre, int calificacion, boolean visitado)
    {
        ...
        labCalificacion.setText("Calificación: ");  // Limpia texto previo, muestra solo estrellas
